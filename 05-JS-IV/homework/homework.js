...
function agregarPropiedad(objeto, property) {
  // Agrega una propiedad al objeto (argumento "objeto") con el
  //valor `null`
  // Devuelve el objeto
...
function tienePropiedad(objeto, propiedad) {
  // Devuelve "true" si el objeto tiene el valor del
  //argumento "propiedad"
...
function agregarAmigo(usuario, nuevoAmigo) {
  // "usuario" tiene una propiedad llamada "amigos" que es un
  //array
